...
class TransactionModel extends Model
{
    ...
    protected $allowedFields = ['transaction_date', 'description', 'status', 'transaction_receipt', 'amount_of_money', 'car_id', 'car_additional_cost_id','payment_sales_id', 'deleted_at'];
    ...
    //     $selectCar = "car.license_number as carLicenseNumber, car.created_at as carDate, car.car_price as carPrice, car.receipt as car_receipt,";
