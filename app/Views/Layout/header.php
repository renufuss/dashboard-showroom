           ...
           <!--begin::Menu wrapper-->
            <div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="click"
                ...
                <div class="symbol symbol-50px">
                    <div class="symbol-label fs-4 fw-semibold bg-danger text-inverse-danger">
                        AA
                    </div>
                </div>
            </div>
           <!--begin::User account menu-->
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                ...
                <div class="menu-item px-3">
                    <div class="menu-content d-flex align-items-center px-3">
                        ...
                        <div class="symbol symbol-50px me-5">
                            <div class="symbol symbol-50px">
                                <div class="symbol-label fs-2 fw-semibold bg-warning text-inverse-danger">
                                    ABC
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex flex-column">
                            <div class="fw-bold d-flex align-items-center fs-7">TES TES
                                <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">BBC</span></div>
                            <a href="#" class="fw-semibold text-muted text-hover-primary fs-8">GHJ</a>
                        </div>
                        <!--end::Username-->
                    </div>
                </div>
                ...
                <div class="menu-item px-5">
                    <a href="<?php echo base_url(); ?>/profile" class="menu-link px-5">Akun Saya</a>
                </div>
                <!--end::Menu item-->
                <!--begin::Menu item-->
                <div class="menu-item px-5 my-1">
                    <a href="<?php echo base_url(); ?>/profile/setting" class="menu-link px-5">Pengaturan Akun</a>
                </div>
                <!--end::Menu item-->
                <!--begin::Menu separator-->
                <div class="separator my-2"></div>
                ...
                <!--begin::Menu item-->
                <div class="menu-item px-5">
                    <a class="menu-link px-5" href="<?php echo base_url('logout'); ?>">Keluar</a>
                </div>
                <!--end::Menu item-->
            </div>
