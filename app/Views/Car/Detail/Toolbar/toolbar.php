	...
	<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
		...
		<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3 desktop-only">
			...
			<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
				...
				<!--begin::Item-->
				<li class="breadcrumb-item text-muted">
					<a href="<?= base_url('mobil'); ?>" class="text-muted text-hover-primary">Mobil</a>
				</li>
				<!--end::Item-->
				<!--begin::Item-->
				<li class="breadcrumb-item">
				...
				<!--end::Item-->
				<!--begin::Item-->
				<li class="breadcrumb-item text-muted"><?= $car->car_name; ?></li>
				<!--end::Item-->
			</ul>
			<!--end::Breadcrumb-->
		</div>
		...
		<div class="d-flex align-items-center gap-2 gap-lg-3">
			<!--begin::Button menu-->
			<a href="<?= base_url('mobil'); ?>" class="btn btn-icon btn-light-warning btn-active-color-light btn-sm">
			...
			<a href="<?= base_url().'/mobil/'.$car->id.'/print'; ?>" target="__blank" class="btn btn-icon btn-light-danger btn-active-color-light btn-sm">
