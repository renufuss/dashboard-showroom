    ...
    <div class="card card-flush py-6 flex-row-fluid">
        ...
        <div class="card-header">
            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                <!--begin::Add product-->
                <span class="badge badge-light-<?= ($sales->total_price - $paid <= 0) ? 'success' : 'danger'; ?> fs-7 fw-bold"><?= ($sales->total_price - $paid <= 0) ? 'Lunas' : 'Belum Lunas'; ?></span>
                <!--end::Add product-->
            </div>
            <!--end::Card toolbar-->
        </div>
                        ...
                        <tr>
                            <td class="text-muted">
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--end::Svg Icon-->Terbayar</div>
                            </td>
                            <td class="fw-bold text-end">
                                <?= "Rp " . number_format($paid, '0', ',', '.'); ?></td>
                        </tr>
                        <!--end::Payment method-->
                        <!--begin::Payment method-->
                        <tr>
                            <td class="text-muted">
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--end::Svg Icon-->Sisa</div>
                            </td>
                            <td class="fw-bold text-end">
                                <?= "Rp " . number_format(($sales->total_price - $paid), '0', ',', '.'); ?></td>
                        </tr>
                        <!--end::Payment method-->
                    </tbody>
                    <!--end::Table body-->
